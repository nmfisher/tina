...
void main() {
  test(
    'cancelling a freeform gate preserves the conversation input owner',
    () async {
      ...
      final question = TinaInterviewer(
        screen: screen,
        editor: editor,
      ).ask(const Question(text: 'What next?', type: QuestionType.freeform));
      await pumpEventQueue();
