...
class _LifecycleProvider extends LlmProvider {
  final bool gated;
  final entered = Completer<void>();
  int closes = 0;
  bool cancelled = false;
  _LifecycleProvider({this.gated = false}) : super('model');
  @override
  Stream<StreamEvent> send(
      {required String system,
      required List<Message> messages,
