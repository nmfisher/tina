...
Future<void> main() async {
  // Test-runner context: `dart test` wraps main in its own zone/timer logic.
  // Reproduce the exact failing test body with a done-timeout probe.
  final conn = await const PtyRunner().spawn(PtySpawnRequest(
    executable: '/bin/sh',
    arguments: ['-c', 'echo "\$PPID-on-\$(tty)-in-\$(pwd)"; echo "V=\$MY_VAR"; exit 7'],
