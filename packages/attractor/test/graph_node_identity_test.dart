...
void main() {
  group(
    'PipelineNode node identity (system_prompt / llm_model / llm_provider)',
    () {
      test('system_prompt is read from the system_prompt attr', () {
        final n = PipelineNode(
          id: 'main',
          attrs: {'system_prompt': 'You are a coding agent.'},
        );
      ...
      test('instructions is accepted as an alias for system_prompt', () {
        final n = PipelineNode(
          id: 'main',
          attrs: {'instructions': 'You review code.'},
        );
      ...
      test('system_prompt prefers system_prompt over instructions', () {
        final n = PipelineNode(
          id: 'main',
          attrs: {'system_prompt': 'primary', 'instructions': 'secondary'},
        );
      ...
      test(
        'modelReference is empty unless both provider and model are set',
        () {
          expect(
