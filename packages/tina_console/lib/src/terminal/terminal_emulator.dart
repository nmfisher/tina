...
class TerminalEmulator {
  ...
  /// DEC Special Graphics for U+0060..U+007E (VT100 manual, 31 glyphs).
  static const List<int> _decGraphics = <int>[
    ...
    0x23ba, // o horizontal scan 1
    0x23bb, // p horizontal scan 3
    0x2500, // q horizontal rule
    0x23bc, // r horizontal scan 7
    0x23bd, // s horizontal scan 9
    0x251c, // t left tee
    0x2524, // u right tee
    0x2534, // v bottom tee
    0x252c, // w top tee
    0x2502, // x vertical rule
    ...
    while (i < _csiParams.length) {
      ...
      switch (p) {
        ...
        case 48:
          ...
          attrs = ext.$1;
          i += ext.$2 - 1; // the loop's own i++ covers the marker itself
        case 39:
